...
interface OutgoingSidebarProps {
  onNavigate?: (page: string) => void;
  currentPage?: string;
}

export const OutgoingSidebar: React.FC<OutgoingSidebarProps> = ({ 
  onNavigate, 
        ...
        {!collapsed && (
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-gray-500 truncate">Dipendente Uscente</div>
            </div>
          </div>
        )}
      ...
      <div className="p-2 border-t border-gray-200 space-y-3">
        {!collapsed && (
          <div className="bg-purple-50 p-3 rounded-lg mx-2">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium">Livello Intermedio</span>
              <div className="flex items-center gap-1">
                <Trophy size={14} className="text-yellow-600" />
                <span className="text-xs font-bold">1250 pts</span>
              </div>
            </div>
            <div className="text-xs text-gray-600">
              250 punti al prossimo livello
            </div>
          </div>
        )}
        ...
        {collapsed && (
          <Tooltip>
            ...
            <TooltipContent side="right" className="ml-2">
              <p>Livello Intermedio - 1250 punti</p>
            </TooltipContent>
          </Tooltip>
        )}
        ...
        {!collapsed && (
          <div className="flex items-center gap-3 mx-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-gray-500 truncate">{user?.position || 'Dipendente'}</div>
            </div>
          </div>
        )}
