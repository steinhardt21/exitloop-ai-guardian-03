/*
  ...
  2. Template
    - CTO Handover (4 sezioni, 10 domande)
    - Marketing Manager (3 sezioni, 6 domande)  
    - Developer Senior (3 sezioni, 6 domande)
    - Sales Manager (3 sezioni, 6 domande)

  3. Handover
    - 5 handover con stati diversi e risposte realistiche
    - Inviti e analisi AI complete

  4. Sicurezza
    - Tutti i dati rispettano le policy RLS
    - Nessuna violazione di foreign key
*/
...
-- Disabilitiamo temporaneamente i trigger per evitare conflitti
ALTER TABLE handover_responses DISABLE TRIGGER trigger_update_completion;
...
-- Riabilitiamo i trigger
ALTER TABLE handover_responses ENABLE TRIGGER trigger_update_completion;
